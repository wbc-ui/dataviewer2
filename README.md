<p align="center">
  <img src="https://cdn.jsdelivr.net/npm/@wbc-ui/dataviewer2/logo/dataviewer2.svg" alt="@wbc-ui/dataviewer2" width="220" style="max-width: 100%;"/>
</p>
...
<p align="center">
<a href="https://www.npmjs.com/package/@wbc-ui/dataviewer2"><img src="https://img.shields.io/npm/v/@wbc-ui/dataviewer2?color=1976D2" alt="npm"></a>
<a href="https://www.npmjs.com/package/@wbc-ui/dataviewer2?activeTab=versions"><img src="https://img.shields.io/npm/dm/@wbc-ui/dataviewer2?color=1976D2" alt="downloads"></a>
<a href="https://github.com/wbc-ui/dataviewer2/blob/main/LICENSE"><img src="https://img.shields.io/npm/l/@wbc-ui/dataviewer2?color=blue" alt="license"></a>
...
<p align="center">
  ...
  <a href="https://github.com/wbc-ui/dataviewer2">🐙 GitHub</a> ·
...
**@wbc-ui/dataviewer2** replaces the bespoke data-table stack — column config, sort handlers, a search box, per-cell edit state, pagination, a theme layer — that every dashboard, admin panel, and API explorer rebuilds from scratch.
...
## What is @wbc-ui/dataviewer2?

A **Vue 2.7+ component** — `<WBDataViewer>` — that turns any JSON value into a live, interactive table. It pairs with `@wbc-ui/core2` (the WBC engine) and is driven entirely by props.
...
- **Vue 2.7.x** (the component targets Vue 2 specifically; Vue 3 tracked separately as `@wbc-ui/dataviewer3`)
- **[`@wbc-ui/core2`](https://www.npmjs.com/package/@wbc-ui/core2)** — the WBC engine the component renders into (brings the Vuetify peer expectations)
- A bundler that understands ESM exports: Vite (recommended), Webpack 5, or Vue CLI 5

### npm (recommended)

```bash
npm install @wbc-ui/core2 @wbc-ui/dataviewer2
...
```bash
# Yarn
yarn add @wbc-ui/core2 @wbc-ui/dataviewer2
yarn add vue@^2.7.16 vuetify@^2.7.2

# pnpm
pnpm add @wbc-ui/core2 @wbc-ui/dataviewer2
...
import wbcCore from '@wbc-ui/core2';        // always first — dataviewer2 registers into it
import WBDataViewer from '@wbc-ui/dataviewer2';
...
| `Cannot find module '@wbc-ui/dataviewer2'` | npm couldn't resolve the package | Confirm install: `npm ls @wbc-ui/dataviewer2`. If empty, `npm install @wbc-ui/dataviewer2@latest`. |
| Table renders but unstyled | Vuetify CSS isn't loaded | Import once in `main.js`: `import 'vuetify/dist/vuetify.min.css';` |
| `WBDataViewer is not a registered component` | `@wbc-ui/core2` was registered but `@wbc-ui/dataviewer2` wasn't | Add `Vue.use(WBDataViewer)` **after** `Vue.use(wbcCore)`. |
...
> **`@wbc-ui/dataviewer2` is open-source and a complete data table today** — rendering, sort, search, column/expression filters, inline editing, themes, and `src`/`project` fetching are free. The Pro lane is narrow and demand-driven; it follows the same open-core tiering as the underlying [`@wbc-ui/core2`](https://www.npmjs.com/package/@wbc-ui/core2) engine.
...
`@wbc-ui/dataviewer2` is a sibling package in the **@wbc-ui** monorepo. Every package is published to npm and shares the same versioning line.
...
| **[`@wbc-ui/dataviewer2`](https://www.npmjs.com/package/@wbc-ui/dataviewer2)** | **JSON / data-table explorer** *(this package)* | 🟢 GA |
